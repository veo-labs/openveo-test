...
/**
 * @module e2e/asserts/TableAssert
 */
 ...
 * @class TableAssert
 * @constructor
 * @param {module:e2e/pages/TablePage~TablePage} page The table page to test
 * @param {module:e2e/helpers/Helper~Helper} helper The helper to manipulate entities without interacting with the web
 * browser
 */
function TableAssert(page, helper) {
  Object.defineProperties(this,

    /** @lends module:e2e/asserts/TableAssert~TableAssert */
    {

      /**
       * The page containing the table to test.
       *
       * @type {module:e2e/pages/TablePage~TablePage}
       * @instance
       * @readonly
       */
      page: {value: page},
       ...
       *
       * @type {module:e2e/helpers/Helper~Helper}
       * @instance
       * @readonly
       */
      helper: {value: helper}
 ...
 * @memberof module:e2e/asserts/TableAssert~TableAssert
 * @this module:e2e/asserts/TableAssert~TableAssert
...
TableAssert.prototype.checkLinesSelection = function(nameProperty) {
  ...
  return browser.waitForAngular().then(function() {
    ...
    self.helper.addEntitiesAuto(name, 2).then(function(addedLines) {
      ...
      assert.eventually.ok(browserExt.getProperty(self.page.selectAllElement, 'checked'));
      ...
      assert.eventually.notOk(browserExt.getProperty(self.page.selectAllElement, 'checked'));
