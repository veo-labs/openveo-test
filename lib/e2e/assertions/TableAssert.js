 ...
 */
TableAssert.prototype.checkLinesSelection = function() {
  var self = this;
  ...
  return browser.waitForAngular().then(function() {
    ...
    self.helper.addEntitiesAuto(name, 2).then(function(addedLines) {
      ...
      lines.forEach(function(line) {
        assert.eventually.ok(self.page.isSelectedLine(line.name));
      });
      ...
      lines.forEach(function(line) {
        self.page.selectLine(line.name);
      });
      ...
      // Deselect one line
      self.page.deselectLine(lines[0].name);
      ...
      // Deselect all lines
      lines.forEach(function(line) {
        self.page.deselectLine(line.name);
      });
