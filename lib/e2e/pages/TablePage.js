...
function TablePage(model) {
  ...
  this.addFormWrapperElement = this.addLinkElement.element(by.xpath('..'))
    .all(by.css('div[collapse="isCollapsed"]')).first();
...
TablePage.prototype.removeLine = function(name) {
  return this.performAction(name, this.getRemoveActionName(), true);
};
...
TablePage.prototype.removeAllSelectedLinesInPage = function() {
  return this.performMultipleAction(this.getRemoveActionName(), true);
};
 ...
 *
 * @method getRemoveActionName
 * @return {String} The name of the remove action
 */
TablePage.prototype.getRemoveActionName = function() {
  throw new Error('Method getRemoveActionName not implemented for this page');
};
