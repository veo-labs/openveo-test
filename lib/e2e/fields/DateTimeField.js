...
DateTimeField.prototype.setValue = function(value) {
  ...
  return this.getElement().then(function(elementFinder) {
    ...
    return protractor.promise.all([
      self.setInputValue(inputDateElement, shortDate),
      self.setInputValue(inputHoursElement, value.getHours()),
      self.setInputValue(inputMinutesElement, value.getMinutes())
    ]);
  });
};
