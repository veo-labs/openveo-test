...
TinyMCEField.prototype.getValue = function() {
  return browser.driver.executeScript('tinyMCE.activeEditor.getContent()');
};
...
TinyMCEField.prototype.setValue = function(value) {
  ...
  return this.clear().then(function() {
    return browser.driver.executeScript('tinyMCE.activeEditor.insertContent("' + value + '")');
  });
};
...
TinyMCEField.prototype.clear = function() {
  return browser.driver.executeScript('tinyMCE.activeEditor.insertContent("")');
};
